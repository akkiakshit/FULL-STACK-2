...
const EditorPanel = () => {
  ...
  return (
    <AppLayout title="Content & Editor Studio">
      <div
        className="card"
        style={{
      ...
      >
        <div style={{ marginBottom: '24px', position: 'relative', borderRadius: '14px', overflow: 'hidden' }}>
          ...
          >
            <div>
              <span className="role-tag-sm badge-editor" style={{ fontSize: '0.8rem', padding: '6px 14px' }}>
                ADMIN & EDITOR ACCESS
              </span>
              <h2 style={{ fontSize: '1.8rem', fontWeight: '800', marginTop: '8px', color: 'white' }}>
                ✏️ Digital Content & Publishing Studio
              </h2>
            </div>
          </div>
        </div>
        ...
        <p style={{ fontSize: '1rem', color: 'var(--text-muted)', lineHeight: '1.6', marginBottom: '24px' }}>
          This panel is accessible by users with <strong>Admin</strong> or <strong>Editor</strong> roles. Editors can draft articles, update system documentation, upload media, and manage published releases.
        </p>
